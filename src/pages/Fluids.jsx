          ...
          {(activeFluidTab === 'reposicion' || activeFluidTab === 'cri') && (
            <div className="bg-[#111111] border border-[#222] rounded-[2rem] p-6 shadow-xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2"><label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Bolsa</label><select value={bolsaVolumen} onChange={e => setBolsaVolumen(e.target.value)} className={`w-full bg-[#1a1a1a] rounded-2xl p-4 text-sm font-bold border-none outline-none focus:ring-2 text-white appearance-none`}><option value="100">100 ml</option><option value="250">250 ml</option><option value="500">500 ml</option><option value="1000">1000 ml</option></select></div>
              </div>
            </div>
          )}
        </div>
